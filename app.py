...
# 🎨 Premium UI Customization CSS (പെർഫെക്റ്റ് ചാറ്റ് ബബിൾസ്)
st.markdown("""
    <style>
...
# 🔑 നിന്റെ കറക്റ്റ് വർക്കിംഗ് ഗ്രോക്ക് കീ
...
if user_query := st.chat_input("Kiara-യോട് സംസാരിക്കൂ..."):
    ...
    with st.spinner("Kiara മറുപടി ആലോചിക്കുന്നു..."):
        try:
            # സിസ്റ്റം ഇൻസ്ട്രക്ഷൻ ഒപ്പം ചാറ്റ് ഹിസ്റ്ററിയും
            history = [
                {
                    "role": "system", 
                    "content": (
