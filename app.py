...
# 🎨 Premium Font & Loading Pulse Effect CSS
st.markdown("""
    <style>
    /* Google Fonts */
    ...
    /* 🌟 ലോഡ് ആകുന്നത് പോലെ പൾസ് ചെയ്യുന്ന ലക്ഷ്വറി ടൈറ്റിൽ */
    ...
    /* Clean Chat Box (No Avatars/Robot icons) */
    .stChatMessage { 
...
# മുകളിൽ ആനിമേഷനോടെയുള്ള 'KIARA' ടെക്സ്റ്റ് കാണിക്കുന്നു
st.markdown("""
    <div class="logo-text-container">
        <div class="kiara-animated-title">KIARA</div>
    </div>
""", unsafe_allow_html=True)
...
if user_query := st.chat_input("Kiara-യോട് സംസാരിക്കൂ..."):
    ...
    with st.chat_message("assistant", avatar=None):
        with st.spinner("Kiara ആലോചിക്കുന്നു..."):
            try:
                # 🧠 ഇവിടെയാണ് ഭാഷ കൺട്രോൾ ചെയ്യുന്ന പ്രോംപ്റ്റ് ഉള്ളത്
                ...
                # ഓഡിയോ ജനറേറ്റ് ചെയ്യുമ്പോൾ മലയാളം/മംഗ്ലീഷ് വോയിസ് കറക്റ്റ് ആകാൻ ഭാഷ ഡിറ്റക്റ്റ് ചെയ്യുന്നു
                # സിംപിൾ ചെക്ക്: മലയാളം അക്ഷരങ്ങൾ ഉണ്ടെങ്കിൽ 'ml', അല്ലെങ്കിൽ 'en'
                ...
                st.audio(audio_bytes, format="audio/mp3") # നീ പ്ലേ നൊക്കുമ്പോൾ മാത്രം പ്ലേ ആകും
