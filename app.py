...
# 🎨 Premium UI Customization CSS (റോബോട്ട് ഐക്കൺ ഇല്ലാത്ത ക്ലീൻ ഡിസൈൻ)
st.markdown("""
    <style>
...
# 🔑 ആതി തന്ന ഒഫീഷ്യൽ ഗൂഗിൾ എപിഐ കീ ഇവിടെ സെറ്റ് ചെയ്തു കഴിഞ്ഞു!
...
if user_query := st.chat_input("Kiara-യോട് സംസാരിക്കൂ..."):
    ...
    with st.spinner("Kiara ഗൂഗിളിൽ തിരയുന്നു..."):
        try:
            # 🧠 ലൈവ് ഗൂഗിൾ സെർച്ച് പവർ ഉള്ള ഒഫീഷ്യൽ മോഡൽ
            model = genai.GenerativeModel(
                model_name="gemini-1.5-pro",
                tools=[{"google_search": {}}], # തത്സമയം ഇന്റർനെറ്റിൽ സെർച്ച് ചെയ്യും
                system_instruction=(
